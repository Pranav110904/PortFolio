...
import hostelsuvidha from '../assets/image.png';
import TripNest from '../assets/TripNest.png';
import GigglioAi from '../assets/GiglioAi.png';
import onlinecsd from '../assets/onlinecsd.png';
import traveltalks from '../assets/traveltalks.png';
import portf from '../assets/portf.png';
import sf from '../assets/sf.png';
import log from '../assets/log.png';
import pace from '../assets/pace.png';
import landpag from '../assets/landpag.png';
import first from '../assets/first.png';
import instachotu from '../assets/instachotu.jpg';
...
const projects = [
  {
    ...
    image: hostelsuvidha, // Replace with your actual image source
  },
  {
    id: 2,
    title: 'TripNest',
    ...
    image: TripNest, // Replace with your actual image source
  },
  {
    id: 3,
    title: 'GigglioAi',
    ...
    image: GigglioAi, // Replace with your actual image source
  },
  {
    id: 4,
    title: 'Online CSD',
    ...
    image: onlinecsd, // Replace with your actual image source
  },
  {
    id: 5,
    title: 'TravelTalks',
    ...
    image: traveltalks, // Replace with your actual image source
  },
];
...
const Project = () => {
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
    ...
    <div class="col-span-1 row-span-2 group relative overflow-hidden rounded-lg shadow-lg w-full min-h-[400px]">
      <img src={portf} alt="Design 1" class="w-full h-full object-cover transition-all duration-300 group-hover:scale-105" />
    ...
    <div class="group relative overflow-hidden rounded-lg shadow-lg w-full min-h-[400px]">
      <img src={sf} alt="Design 2" class="w-full h-full object-cover transition-all duration-300 group-hover:scale-105" />
      <div class="absolute inset-0 bg-black bg-opacity-50 flex justify-center items-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
    ...
    <div class="col-span-2 group relative overflow-hidden rounded-lg shadow-lg w-full min-h-[400px]">
      <img src={log} alt="Design 3" class="w-full h-full object-cover transition-all duration-300 group-hover:scale-105" />
      <div class="absolute inset-0 bg-black bg-opacity-50 flex justify-center items-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
    ...
    <div class="group relative overflow-hidden rounded-lg shadow-lg w-full min-h-[400px]">
      <img src={pace} alt="Design 4" class="w-full h-full object-cover transition-all duration-300 group-hover:scale-105" />
      <div class="absolute inset-0 bg-black bg-opacity-50 flex justify-center items-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
    ...
    <div class="col-span-1 row-span-2 group relative overflow-hidden rounded-lg shadow-lg w-full min-h-[400px]">
      <img src={landpag} alt="Design 5" class="w-full h-full object-cover transition-all duration-300 group-hover:scale-105" />
      <div class="absolute inset-0 bg-black bg-opacity-50 flex justify-center items-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
    ...
    <div class="group relative overflow-hidden rounded-lg shadow-lg w-full min-h-[400px]">
      <img src={first} alt="Design 6" class="w-full h-full object-cover transition-all duration-300 group-hover:scale-105" />
      <div class="absolute inset-0 bg-black bg-opacity-50 flex justify-center items-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
    ...
    <div class="col-span-2 group relative overflow-hidden rounded-lg shadow-lg w-full min-h-[400px]">
      <img src={instachotu} alt="Design 7" class="w-full h-full object-cover transition-all duration-300 group-hover:scale-105" />
      <div class="absolute inset-0 bg-black bg-opacity-50 flex justify-center items-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
    ...
    <div class="group relative overflow-hidden rounded-lg shadow-lg w-full min-h-[400px]">
      <img src={chotu} alt="Design 8" class="w-full h-full object-cover transition-all duration-300 group-hover:scale-105" />
      <div class="absolute inset-0 bg-black bg-opacity-50 flex justify-center items-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
