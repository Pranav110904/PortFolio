...
const projects = [
  {
    ...
    image: 'src/assets/image.png', // Replace with your actual image source
  },
  {
    id: 2,
    title: 'TripNest',
    ...
    image: '/src/assets/TripNest.png', // Replace with your actual image source
  },
  {
    id: 3,
    title: 'GigglioAi',
    ...
    image: '/src/assets/GiglioAi.png', // Replace with your actual image source
  },
  {
    id: 4,
    title: 'Online CSD',
    ...
    image: '/src/assets/onlinecsd.png', // Replace with your actual image source
  },
  {
    id: 5,
    title: 'TravelTalks',
    ...
    image: '/src/assets/traveltalks.png', // Replace with your actual image source
  },
];
...
const Project = () => {
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
    ...
    <div class="col-span-1 row-span-2 group relative overflow-hidden rounded-lg shadow-lg w-full min-h-[400px]">
      <img src="/src/assets/portf.png" alt="Design 1" class="w-full h-full object-cover transition-all duration-300 group-hover:scale-105" />
    ...
    <div class="group relative overflow-hidden rounded-lg shadow-lg w-full min-h-[400px]">
      <img src="./src/assets/sf.png" alt="Design 2" class="w-full h-full object-cover transition-all duration-300 group-hover:scale-105" />
      <div class="absolute inset-0 bg-black bg-opacity-50 flex justify-center items-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
    ...
    <div class="col-span-2 group relative overflow-hidden rounded-lg shadow-lg w-full min-h-[400px]">
      <img src="./src/assets/log.png" alt="Design 3" class="w-full h-full object-cover transition-all duration-300 group-hover:scale-105" />
      <div class="absolute inset-0 bg-black bg-opacity-50 flex justify-center items-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
    ...
    <div class="group relative overflow-hidden rounded-lg shadow-lg w-full min-h-[400px]">
      <img src="src/assets/pace.png" alt="Design 4" class="w-full h-full object-cover transition-all duration-300 group-hover:scale-105" />
      <div class="absolute inset-0 bg-black bg-opacity-50 flex justify-center items-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
    ...
    <div class="col-span-1 row-span-2 group relative overflow-hidden rounded-lg shadow-lg w-full min-h-[400px]">
      <img src="src/assets/landpag.png" alt="Design 5" class="w-full h-full object-cover transition-all duration-300 group-hover:scale-105" />
      <div class="absolute inset-0 bg-black bg-opacity-50 flex justify-center items-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
    ...
    <div class="group relative overflow-hidden rounded-lg shadow-lg w-full min-h-[400px]">
      <img src="/src/assets/first.png" alt="Design 6" class="w-full h-full object-cover transition-all duration-300 group-hover:scale-105" />
      <div class="absolute inset-0 bg-black bg-opacity-50 flex justify-center items-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
    ...
    <div class="col-span-2 group relative overflow-hidden rounded-lg shadow-lg w-full min-h-[400px]">
      <img src="/src/assets/instachotu.jpg" alt="Design 7" class="w-full h-full object-cover transition-all duration-300 group-hover:scale-105" />
      <div class="absolute inset-0 bg-black bg-opacity-50 flex justify-center items-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
    ...
    <div class="group relative overflow-hidden rounded-lg shadow-lg w-full min-h-[400px]">
      <img src="src/assets/chotu.png" alt="Design 8" class="w-full h-full object-cover transition-all duration-300 group-hover:scale-105" />
      <div class="absolute inset-0 bg-black bg-opacity-50 flex justify-center items-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
