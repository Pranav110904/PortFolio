...
import '../Components/SphereAnimation.css';
      ...
      begin: function () {
        for (let i = 0; i < pathLength; i++) {
          animations.push(anime({
            ...
            stroke: { value: ['rgba(4, 176, 237, 1)', 'rgba(135, 238, 184, 1)'], duration: 500 },
            strokeWidth: { value: [1, 2], duration: 500 }, // Increase stroke width dynamically
            strokeLinejoin: 'round', // Make corners rounded
            translateX: [2, -4],
            translateY: [2, -4],
            easing: 'easeOutQuad',
            autoplay: false
